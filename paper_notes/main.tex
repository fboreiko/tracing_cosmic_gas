...
Inside $r_{200m}$ the reconstruction still describes a halo as a smooth ball: one
...
than a smooth ball does. $R$ therefore falls short of the $R_\star$ of
Equation~\eqref{eq:T_split}, and it falls short precisely on the scales of the
clumps rather than on the scale of the halo.

Measuring the profile does not repair this, and the reason is now sharper than a
statement about NFW being the wrong shape: $\bar u_m$ is \emph{still a radial
profile}. It records how much matter lies at each radius and remains silent on
whether that matter is spread evenly around the shell or piled into a few
