...
mpiexec -n $SLURM_NTASKS python -u get_AP_simple_jax_batched.py
...
OUTPUT_PATTERN="data/simple_*CAP_code/fullFT_tau_reconstruction*/tau_apertures_*/tau_apertures_z_*.npz"
